...
export const ReferenceList = [
  {
    ...
    company: 'Fairview Containers',
    image: FC,
    recommendation:
      'I had the pleasure of working with Eugene on my website creation and design. Even though the process turned out to be more detailed than I had anticipated, Eugene took the time to make sure every aspect of the project was just right. His service was professional. He was clear and upfront. He delivered the result I was looking for in the timely manner that suited my needs!!',
    contactUrl: 'https://www.facebook.com/profile.php?id=100083183859127',
    companyUrl: 'https://fairviewcontainersllc.com/',
  },
  {
    id: 2,
    defaultChecked: false, // fix
    ...
    contactUrl: 'https://www.linkedin.com/in/jacobvoronin/',
  ...
  },
  {
    ...
    contactUrl: 'https://www.linkedin.com/in/stepan-misiruk/',
  ...
  },
  {
    ...
    contactUrl: 'https://www.linkedin.com/in/ben-yurkin/',
    companyUrl: 'https://www.accenture.com/us-en',
  },
  {
    id: 5,
